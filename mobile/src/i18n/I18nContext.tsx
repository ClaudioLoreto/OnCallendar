...
const dictionaries: Record<Locale, Dict> = {
  it: {
    ...
    'notifPrefs.title': 'Preferenze notifiche',
    'notifPrefs.intro': 'Scegli per quali eventi vuoi ricevere notifiche. Tutte le notifiche sono attive per impostazione predefinita.',
    'notifPrefs.open': 'Apri preferenze',
    ...
    'login.title': 'Accedi',
    'login.email': 'Email o badge',
    'login.emailPlaceholder': 'Email o badge',
  ...
  en: {
    ...
    'notifPrefs.intro': 'Choose which events you want to be notified about. All notifications are enabled by default.',
    'notifPrefs.open': 'Open preferences',
    ...
    'login.title': 'Sign in',
    'login.email': 'Email or badge',
    'login.emailPlaceholder': 'Email or badge',
    'login.password': 'Password',
