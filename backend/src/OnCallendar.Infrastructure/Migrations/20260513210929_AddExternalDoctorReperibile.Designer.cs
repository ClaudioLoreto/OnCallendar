...
namespace OnCallendar.Infrastructure.Migrations
{
    ...
    [Migration("20260513210929_AddExternalDoctorReperibile")]
    partial class AddExternalDoctorReperibile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnCallendar.Domain.Entities.ExternalDoctor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ExternalDoctors", (string)null);
                });
            ...
            modelBuilder.Entity("OnCallendar.Domain.Entities.SwapCounterOffer", b =>
                {
                    ...
                    b.ToTable("SwapCounterOffers", (string)null);
                });
            ...
            modelBuilder.Entity("OnCallendar.Domain.Entities.SwapRequest", b =>
                {
                    ...
                    b.HasIndex("InitiatorShiftId", "Status");
